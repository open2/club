...
<tr>
  ...
  <td height=30 colspan=2 valign=bottom bgcolor="eeeeee"><table width="100%" height="30" border="0" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td><span class="style5">사용자ID 검색</span></td>
    </tr>
  </table></td>
</tr>
<tr>
...
<tr>
    ...
    <input type=text name=sname value='<?=$sname?>' required minlength=2 itemname='회원이름' size=14> <input type=image src='<?=$nc[cb_path]?>/images/btn_search.gif' border=0 align=absmiddle></td>
</tr>
<tr>
