...
$bgcolor = "#FBFBFB";
if ($cb[cb_box_line_skin]) $bgcolor = $cb[cb_box_line_skin];
?>
<div style="width:176px; height:160px; border:2px solid <?=$cb[cb_box_line_skin]?>;">
<table width="176" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td width="151" bgcolor="#FBFBFB"><table width="100%" border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
          <td colspan="3"><a href="<?=$nc[cb_path]?>/bbs/member_confirm.php?url=register_form.php"><img src="<?=$cb_outlogin_skin?>/btn_info.gif" border="0" alt="정보수정"></a><? if ($cb[cb_id]) { ?><a href="<?=$g4[bbs_path]?>/logout.php?url=<?=$g4[path]?>/club/club_main.php?cb_id=<?=$cb[cb_id]?>" target=_top><? } else { ?><a href="<?=$g4[bbs_path]?>/logout.php?url=<?=$g4[path]?>/club/" target=_top><? } ?><img src="<?=$cb_outlogin_skin?>/btn_logout.gif" border="0" alt="로그아웃"></a></td>
          </tr>
          </table></td>
